...
@endif
	...
	<div class="product-info">
		...
		<div class="meta-info">
			<div class="pinfo">
				<div>Copiers</div>
				<div>{{$trader->copier}}</div>
			</div>

            <div class="pinfo">
				<div>Gains</div>
				<div>{{$trader->gains}}</div>
			</div>
			...
			<div class="pinfo">
				...
				<div>{{$trader->total_transactions}}</div>
			</div>
			<div class="pinfo">
				<div></div>
				<div></div>

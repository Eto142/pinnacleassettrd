...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        <div class="middle-content p-0">
                <div wire:id="XEos4e7s0l1xQHirNPFy" wire:initial-data="{&quot;fingerprint&quot;:{&quot;id&quot;:&quot;XEos4e7s0l1xQHirNPFy&quot;,&quot;name&quot;:&quot;common.profile-component&quot;,&quot;locale&quot;:&quot;en&quot;,&quot;path&quot;:&quot;profile&quot;,&quot;method&quot;:&quot;GET&quot;,&quot;v&quot;:&quot;acj&quot;},&quot;effects&quot;:{&quot;listeners&quot;:[]},&quot;serverMemo&quot;:{&quot;children&quot;:{&quot;l2435479828-0&quot;:{&quot;id&quot;:&quot;1EZ5lQzIctsrr0zD3U3T&quot;,&quot;tag&quot;:&quot;div&quot;},&quot;l2435479828-1&quot;:{&quot;id&quot;:&quot;sj12ZLxDPG6EbDkLlzZT&quot;,&quot;tag&quot;:&quot;div&quot;}},&quot;errors&quot;:[],&quot;htmlHash&quot;:&quot;7e6ac500&quot;,&quot;data&quot;:{&quot;userData&quot;:[],&quot;param&quot;:false,&quot;tabGeneral&quot;:&quot;generalInformation&quot;,&quot;hedge_module&quot;:false,&quot;crm_module&quot;:false,&quot;kyc_module&quot;:true,&quot;funding_module&quot;:true,&quot;kycProviderActive&quot;:&quot;Metamap&quot;,&quot;dataTab&quot;:[&quot;generalInformation&quot;,&quot;security&quot;,&quot;transactionHistory&quot;,&quot;referrals&quot;,&quot;deposit&quot;,&quot;withdraw&quot;,&quot;depositInfo&quot;,&quot;kyc&quot;,&quot;challenges&quot;]},&quot;dataMeta&quot;:{&quot;models&quot;:{&quot;userData&quot;:{&quot;class&quot;:&quot;App\\Models\\User&quot;,&quot;id&quot;:249387,&quot;relations&quot;:[&quot;lang&quot;,&quot;permissions&quot;,&quot;roles&quot;],&quot;connection&quot;:&quot;mysql&quot;,&quot;collectionClass&quot;:null}}},&quot;checksum&quot;:&quot;9786a58411200d429e77f6177f6ba3836efc0e03a201e054a76f43cfe7d30a2c&quot;}}">
...
<div class="animated-underline-content">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a  class="nav-link active" data-bs-toggle="tab" href="{{url('photo')}}" role="tab"  style="padding: 5px 0.5rem">
                Profile Picture
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="{{url('profile')}}" role="tab" style="padding: 5px 0.5rem">
                General Information
            </a>
        </li>
                            <li class="nav-item">
...
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/filepond.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginFileValidateType.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginImageExifOrientation.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginImagePreview.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginImageCrop.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginImageResize.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/FilePondPluginImageTransform.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/filepond/filepondPluginFileValidateSize.min.js"></script>
<script src="https://my.consummatetraders.com/theme/assets/js/users/account-settings.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/notification/snackbar/snackbar.min.js"></script>
<script src="https://my.consummatetraders.com/theme/plugins/src/sweetalerts2/sweetalerts2.min.js"></script>
<script src="https://web-button.getmati.com/button.js"></script>

<script src = "https://my.consummatetraders.com/theme/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="https://my.consummatetraders.com/css/main/otro.js"></script>

<script>
document.addEventListener('DOMContentLoaded', function() {
                    /* ========== start General information/Profile ========== */
        window.livewire.on('pass-showModal', Msg => {
            $('#modalPass').modal('show')
        });
        window.livewire.on('pass-hideModal', Msg => {
            $('#modalPass').modal('hide')
        });
        /* ========== end General information/Profile ========== */
    
    /* ========== start Transaction history ========== */
    /*Livewire.on('exec', Msg => {
        historybalans();
    });*/
    /* ========== end Transaction history ========== */
});

$('.month-summary').click(function(e){
...
const ps = new PerfectScrollbar('#psb');
        ...
        Swal.fire({
            ...
            if (result.value) {
                Livewire.emit('removeUserClient');
            }
        });
    }

    /* ========== start Security ========== */
    function confirmChangeTypeVerification(tnew) {
        Swal.fire({
            title: "Are you sure?",
            text: "To change security type verification?",
            icon: 'warning',
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#1b2e4b',
            showCancelButton: true,
            ...
            if(result.value) {
                Livewire.emit('activateSecurityTypeVerification', tnew);
            }
        });
    }
    /* ========== end Security ========== */

/* ========== start Metatrader account ========== */
window.livewire.on('trades-showModal', msg => {
    $('#trades').modal('show')
});
/* ========== end Metatrader account ========== */

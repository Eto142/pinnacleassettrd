...
<head>
    ...
    <title>Altruistic Markets | User Login</title>
            ...
            @endif
                            ...
                            <form method="POST" action="{{ route('admin.login.store') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-dark">&copy; Copyright  2023 &nbsp; Altruistic Markets &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->

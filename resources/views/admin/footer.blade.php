  ...
  <table>
        <tr>
               <td style="font-size:9pt;text-align:center;">
                ...
                <img src="{{asset('user/icon/dashboard.png')}}" style="width:20px;height:20px"><br>Dashboard</a>
            </td>
            <td style="font-size:9pt;text-align:center;">
                  <a class="" href="{{url('manage-deposit')}}" style="margin-right:10px">
                <img src="{{asset('user/icon/Copy Trader.png')}}" style="width:20px;height:20px"><br>Deposits</a>
                </td>
              
               <td style="font-size:9pt;text-align:center;">  <a class="" href=""  style="margin-right:10px">
                   <img src="{{asset('user/icon/history.png')}}" style="width:20px;height:20px"><br></a>
                   </td>
              <td style="font-size:9pt;text-align:center;">  <a class="" href="" style="margin-right:10px">

  ...
  public function store(Request $request)
{
    ...
    return redirect()->route('admin.bots.index')->with('success', 'Bot created successfully.');
}
   ...
   public function update(Request $request, Bot $bot)
    ...
    return redirect()->route('admin.bots.index')->with('success', 'Bot updated successfully.');
}

...
<head>
    ...
    <title>Fund For Me Program</title>
                            ...
                            <table border='0' width='100%' cellpadding='0' cellspacing='0'>
                                <tr>
                                    <td align='center' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
                                        <h2>Welcome to Fund For Me Program</h2>
                                        <br>
                                        <br>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                        Thanks for joining Fund For Me Program as your new home. We're excited to have you on board!
                                        </p>
                                        <p style='line-height: 24px;margin-bottom:15px;'>
                                          Account Details:
                                        </p>
                                ...
                                <tr>
                                    <td align='left' style='color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <div style='line-height: 24px;'>
                                            ...
                                            <span style='color: #333333;'> Fund For Me Program Copyright 2024 -  All Rights Reserved</span>

...
<div class="animated-underline-content">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active"  href="{{url('kyc')}}" role="tab" aria-selected="true" style="padding: 5px 0.5rem">
                Kyc
            </a>
        </li>
        <li class="nav-item">
...
<div class="widget-content widget-content-area">
    <div class="d-flex justify-content-between align-items-center">
        <h5 class="">
            ...
            <div class="user-status user-status-unverified" style="color:orange">Unverified</div>
            @elseif(Auth::user()->kyc_status==='1')
            <div class="user-status user-status-verified" style="color:green">verified</div>
            @elseif(Auth::user()->kyc_status==='2')
            <div class="user-status user-status-unverified" style="color:red">Failed</div>
            @endif
        </h5>

...
<div class="widget-header">
    <div class="row">
        <div class="col-12 col-sm-12 d-flex align-items-center justify-content-center mt-2">
            <h6 class="m-0" style="padding: 16px 15px;"> All Transaction History</h6>
        </div>
    </div>
</div>
...
<div class="statbox widget box box-shadow">
    ...
    <div class="toolbar align-self-center" style="padding-right: 15px">
        <button wire:click.prevent="exportReport('w', 1385368)" class="btn btn-primary"> <i class="fa fa-file-excel"> </i> Deposit History</button>
    </div>
    ...
    <div class="widget-content widget-content-area pt-3">
        <div class="card-body p-0">
            ...
            <div class="toolbar align-self-center" style="padding-right: 15px">
                <button wire:click.prevent="exportReport('w', 1385368)" class="btn btn-primary"> <i class="fa fa-file-excel"> </i> Withdrawal History</button>
            </div>

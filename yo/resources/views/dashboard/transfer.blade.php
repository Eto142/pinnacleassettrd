...
<div id="tabsIcons" class="col-xxl-4 col-xl-5 col-lg-6 col-md-6 col-12 d-flex flex-column align-self-center mx-auto mt-1">
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
                  ...
                  Choose Preffered Transfer Method
                </div>
                                <div class="row">
                  ...
                  <form accept-charset="utf-8" method="post" action="{{url('make-transfer')}}">
                                        {{csrf_field()}}
                <div class="col-12 mb-3">
                    <div class="form-group">
                        <label class="mb-0">amount<code>*</code></label>
                        <input type="number" class="form-control"  name="amount"placeholder="Enter the amount to transfer"/>
                                                                                    </div>
                </div>

                <div class="col-12 mb-3">
                    <div class="form-group">
                        <label class="mb-0">Transfer With<code>*</code></label>
                        <select name="mode" class="form-select" data-live-search="true" tabindex="null" >
                ...
                <div class="col-12 mb-3">
                  <div class="form-group">
                      <label class="mb-0">Enter Wallet Address<code>*</code></label>
                      <input type="text" class="form-control"  name="wallet_address"placeholder="Enter Wallet Address"/>
                                                                                  </div>
              </div>
                <button class = "btn btn-info">Proceed to Transfer</button>

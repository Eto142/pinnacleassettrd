                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuLink">
                                                                                                        ...
                                                                                                        <a class="m-1 btn btn-danger btn-sm" href="https://altruisticmarkets.com/account/admin/dashboard/ublock/1">Block</a>
										...
										<div id="resetpswdModal1" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body bg-dark p-3">
                                                    ...
                                                    <a class="btn btn-danger" href="https://altruisticmarkets.com/account/admin/dashboard/resetadpwd/1">Reset Now</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
										...
										<div id="deleteModal1" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body bg-dark p-3">
                                                    ...
                                                    <a class="btn btn-danger" href="https://altruisticmarkets.com/account/admin/dashboard/deleletadmin/1">Yes i'm sure</a>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body bg-dark">
                                                        <form style="padding:3px;" role="form" method="post" action="https://altruisticmarkets.com/account/admin/dashboard/editadmin">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body bg-dark">
                                                    ...
                                                    <form role="form" method="post" action="https://altruisticmarkets.com/account/admin/dashboard/sendmail">
                                                        <input type="hidden" name="user_id" value="1">
